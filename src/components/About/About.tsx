        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-4xl mx-auto mb-8">
              ...
              applications. Over the past year, I{`'`}ve built several projects
              that strengthened my understanding of modern web technologies and
              good coding practices. I{`'`}m especially interested in creating
              clean, responsive, and user-friendly experiences.
            </p>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              I{`'`}m always eager to learn, improve my skills, and collaborate
              with others. My goal is to keep growing as a developer while
